package com.rj.mutator;

import com.coxautodev.graphql.tools.GraphQLMutationResolver;
import com.rj.entity.Application;
import com.rj.exception.ApplicationNotFoundException;
...
public class Mutation implements GraphQLMutationResolver {
    ...
    public Mutation(ApplicationRepository applicationRepository){this.applicationRepository=applicationRepository;}
